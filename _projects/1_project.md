...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/project/boostore.png" title="boostore usage example" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<div class="caption">
    Boostore service usage example
</div>
